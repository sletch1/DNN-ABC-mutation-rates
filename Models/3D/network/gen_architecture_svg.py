...
def main():
    ...
    parts = [
        ...
        f'aria-label="Architecture of the 3-D two-stage surrogate network">',
        ...
        text(W / 2, 52, "3-D two-stage surrogate", size=18, weight="600"),
        text(W / 2, 74,
             "(log&#8321;&#8320; p&#8321;, log&#8321;&#8320; p&#8322;, &#964;) "
             "&#8594; mean and variance of log&#8321;&#8320; S",
             size=12.5, fill=MUTED),
    ]

    x = PAD + 6
    parts.append(box(x, ROW_Y, BOX_W, BOX_H, IN_FILL, IN_EDGE, IN_INK, "Inputs",
                     "log&#8321;&#8320; p&#8321; &#183; log&#8321;&#8320; p&#8322; "
                     "&#183; &#964;", "standardised"))
    x += BOX_W
    ...
    for h, act in zip(hidden, acts):
        ...
        parts.append(dim_label(x + GAP / 2, spine, str(len(feats)) if x == PAD + 6 + BOX_W
                               else str(prev_h)))
        x += GAP
